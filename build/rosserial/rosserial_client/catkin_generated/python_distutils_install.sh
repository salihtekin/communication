...
echo_and_run cd "/home/salih/communication/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/salih/communication/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/salih/communication/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
