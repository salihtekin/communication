...
echo_and_run cd "/home/salih/communication/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/salih/communication/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/salih/communication/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
