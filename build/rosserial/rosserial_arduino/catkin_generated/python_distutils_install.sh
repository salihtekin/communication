...
echo_and_run cd "/home/salih/communication/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/salih/communication/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/salih/communication/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
